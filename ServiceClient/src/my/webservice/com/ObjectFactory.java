...
public class ObjectFactory {
    ...
    private final static QName _AuthenticateResponse_QNAME = new QName("my.webservice.com", "authenticateResponse");
    private final static QName _Authenticate_QNAME = new QName("my.webservice.com", "authenticate");
     ...
     * 
     */
    @XmlElementDecl(namespace = "my.webservice.com", name = "authenticateResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "my.webservice.com", name = "authenticate")

 ...
 * 
 */
@WebServiceClient(name = "BankService", targetNamespace = "http://www.bankservice.com", wsdlLocation = "file:/C:/Users/Pontus/Documents/GitHub/stuff-2-2016/webService/src/bank.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKSERVICE_QNAME = new QName("http://www.bankservice.com", "BankService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Pontus/Documents/GitHub/stuff-2-2016/webService/src/bank.wsdl");
    ...
    public BankService getBankPort() {
        return super.getPort(new QName("http://www.bankservice.com", "BankPort"), BankService.class);
    }
     ...
     */
    @WebEndpoint(name = "BankPort")
    public BankService getBankPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.bankservice.com", "BankPort"), BankService.class, features);
    }

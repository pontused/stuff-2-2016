...
public interface BankServiceImpl {
    ...
    @RequestWrapper(localName = "withdraw", targetNamespace = "http://bank.service/", className = "service.booking.com.bank.Withdraw")
    @ResponseWrapper(localName = "withdrawResponse", targetNamespace = "http://bank.service/", className = "service.booking.com.bank.WithdrawResponse")
    ...
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "checkAccount", targetNamespace = "http://bank.service/", className = "service.booking.com.bank.CheckAccount")
    @ResponseWrapper(localName = "checkAccountResponse", targetNamespace = "http://bank.service/", className = "service.booking.com.bank.CheckAccountResponse")

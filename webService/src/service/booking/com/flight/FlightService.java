...
public interface FlightService {
     ...
     * @param arg0
     * @return
     *     returns java.util.List<service.booking.com.flight.Flight>
     * @throws ParseException_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getFlights", targetNamespace = "http://www.flightservice.com", className = "service.booking.com.flight.GetFlights")
    @ResponseWrapper(localName = "getFlightsResponse", targetNamespace = "http://www.flightservice.com", className = "service.booking.com.flight.GetFlightsResponse")
     ...
     * @param arg0
     * @return
     *     returns service.booking.com.flight.Flight
     * @throws FlightDoesNotExistException_Exception
     * @throws NotAuthenticatedException_Exception
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getFlightByID", targetNamespace = "http://www.flightservice.com", className = "service.booking.com.flight.GetFlightByID")
    @ResponseWrapper(localName = "getFlightByIDResponse", targetNamespace = "http://www.flightservice.com", className = "service.booking.com.flight.GetFlightByIDResponse")
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "lockBookSeat", targetNamespace = "http://www.flightservice.com", className = "service.booking.com.flight.LockBookSeat")
    @ResponseWrapper(localName = "lockBookSeatResponse", targetNamespace = "http://www.flightservice.com", className = "service.booking.com.flight.LockBookSeatResponse")
